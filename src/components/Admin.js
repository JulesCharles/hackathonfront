  ...
  return (
    <div>
      <div className='nameOlivia'>
        <img className='photoOlivia' src={avatar} alt='Photo de Profil' />
        <p className='bonjour'>Bonjour OLIVIA !</p>
        <img
          className='barreProgress'
          src={barreProgress}
        ...
        <div className='quizzAccueil'>
          <div className='un'>
            {' '}
            <img className='logoQuiz' src={logoQuiz} alt='logoQuiz' />
            <br />
        ...
        <div className='boxLots'>
          <h1 className='titre'>
            Lots à gagner : <br />
            <img className='stylo' src={stylo} alt='Stylo' />{' '}
            <p className='textStylo'> Un stylo BP</p>
          </h1>
        </div>
      </div>
    </div>
